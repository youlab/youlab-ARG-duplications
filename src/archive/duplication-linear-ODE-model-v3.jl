...
load("../results/diagrams/toy-model-v2.jpg")
...
$\frac{dx_1}{dt} = f_1x_1 (1 - \Sigma x_i) - Dx_1 - (d + \eta)x_1 + r x_2 + r x_3$

$\frac{dx_2}{dt} = f_2x_2 (1 - \Sigma x_i) - Dx_2 + d x_1 - r x_2$

$\frac{dx_3}{dt} = f_3x_3 (1 - \Sigma x_i) - Dx_3 + \eta x_1 - r x_3$
...
function dynamics!(du, u, p, t)	
    	...
    	du[1] = dx1 = f1*x1*(1 - xtotal) - D*x1 - (d + η)*x1 + r*x2 + r*x3
		du[2] = dx2 = f2*x2*(1 - xtotal) - D*x2 + d*x1 - r*x2
		du[3] = dx3 = f3*x3*(1 - xtotal) - D*x3 + η*x1 - r*x3
end
...
# ╔═╡ e318ebc3-c860-4240-87bf-83241c1ec223
antibiotic_prob = ODEProblem(dynamics!, u₀, tspan, antibiotic_treatment);	

# ╔═╡ c9f25cfe-4ac9-4b36-9cdc-da534f4277ba
antibiotic_sol = solve(antibiotic_prob);

# ╔═╡ db04104c-d123-4b36-a5a7-f76ae11ce565
